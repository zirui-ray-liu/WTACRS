...
from seq2seq.data import DefaulDataCollator
...
def main():
    ...
    if "roberta" in model_args.model_name_or_path:
        ...
        from seq2seq.third_party.models import RobertaConfig, RobertaModel, RobertaForSequenceClassification
    ...
    def preprocess_function_shift(examples, max_target_length):
    ...
    preprocess_function_chosen = preprocess_function_t5_mlm if adapter_args.train_t5_mlm else preprocess_function_shift
    ...
    if data_args.pad_to_max_length:
        ...
        # ############ Revised by GC
        data_collator = DefaulDataCollator(
            tokenizer,
    ...
    trainer = Seq2SeqTrainer(
        ...
        eval_dataset=list(eval_datasets.values())[0] if training_args.do_eval else None, # eval_dataset if training_args.do_eval else None,
