...
# python scripts/update_scripts_for_given_input.py $update_file_name task_adapter_layers_encoder list ${encoder_list} $update_file_name
# python scripts/update_scripts_for_given_input.py $update_file_name trainable_encoder_layers list ${encoder_list} $update_file_name
# python scripts/update_scripts_for_given_input.py $update_file_name task_adapter_layers_decoder list ${decoder_list} $update_file_name
# python scripts/update_scripts_for_given_input.py $update_file_name trainable_decoder_layers list ${decoder_list} $update_file_name
...
python scripts/update_scripts_for_given_input.py $update_file_name trainable_decoder_layers eval None $update_file_name
