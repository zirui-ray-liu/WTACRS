...
encoder_side_layers="0,1,2,3,5,6,7,9,10,11"

# Hyper-parameter for Setting
python scripts/update_scripts_for_given_input.py $update_file_name model_name_or_path str t5-base $update_file_name
python scripts/update_scripts_for_given_input.py $update_file_name tokenizer_name str t5-base $update_file_name
