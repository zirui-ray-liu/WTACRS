...
encoder_side_layers="0,1,2,3,4,5,18,19,20,21,22,23" # "0,1,2,3,5,6,7,9,10,11"
...
python scripts/update_scripts_for_given_input.py $update_file_name num_train_epochs int 1 $update_file_name # ${num_epochs[$2]}
